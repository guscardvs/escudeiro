...
#[pyfunction]
pub fn replace_all(value: String, replacements: HashMap<String, String>) -> String {
    replacements
        .iter()
...
#[pyfunction]
pub fn replace_by(value: &str, replacement: &str, to_replace: Vec<String>) -> String {
...
static SNAKE_KEBAB_CASE_REGEX: Lazy<Regex> = Lazy::new(|| Regex::new("(_|-)([a-zA-Z])").unwrap());

#[pyfunction]
pub fn to_snake(value: String) -> String {
    replace_by(
...
#[pyfunction]
pub fn to_camel(value: String) -> String {
...
#[pyfunction]
pub fn to_pascal(value: String) -> String {
    if value.is_empty() {
        return value;
    }
...
pub fn to_kebab(value: String, remove_trailing_underscores: bool) -> String {
...
#[pyfunction]
pub fn squote(value: String) -> String {
    format!("'{value}'")
}

#[pyfunction]
pub fn dquote(value: String) -> String {
    format!("\"{value}\"")
}
...
#[pyfunction]
pub fn sentence(value: String) -> String {
    format!(
        "{formatted}.",
...
#[pyfunction]
pub fn exclamation(value: String) -> String {
    format!(
        "{formatted}!",
        formatted = value.trim_end_matches(trim_punctiation)
    )
...
#[pyfunction]
pub fn question(value: String) -> String {
    format!(
        "{formatted}?",
        formatted = value.trim_end_matches(trim_punctiation)
    )
