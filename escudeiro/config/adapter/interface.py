...
if TYPE_CHECKING:
    ...
    from escudeiro.data.field_ import Field as SField

    from .pydantic import FieldWrapper

T_co = TypeVar(
    "T_co", "FieldWrapper", "Attribute", "Field", "SField", covariant=True
)
...
class FieldResolverStrategy(Protocol[T_co]):
    ...
    @classmethod
    def iterfield(cls, config_class: type) -> Generator[T_co, Any, Any]: ...
